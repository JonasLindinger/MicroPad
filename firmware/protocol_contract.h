...
inline constexpr char TOPIC_FRAME[] = "micropad/display/frame";
inline constexpr char TOPIC_KEYMAP[] = "micropad/keymap";
inline constexpr char TOPIC_PAGES[] = "micropad/pages/all";
inline constexpr char TOPIC_PLAYER_CONTROL[] = "micropad/player/control";
inline constexpr char TOPIC_PLAYER_QUEUE[] = "micropad/player/queue";
inline constexpr char TOPIC_PLAYER_READY[] = "micropad/player/ready";
inline constexpr char TOPIC_PLAYER_STATE[] = "micropad/player/state";
