...
_SERVICE_BY_ACTION_DOMAIN = {
    ...
    ("on", "fan"): "fan.turn_on",
    ("off", "fan"): "fan.turn_off",
    ("toggle", "input_boolean"): "input_boolean.toggle",
    ("on", "input_boolean"): "input_boolean.turn_on",
    ("off", "input_boolean"): "input_boolean.turn_off",
    # A lock has no toggle service: locking is "on", unlocking is "off".
    ("on", "lock"): "lock.lock",
    ("off", "lock"): "lock.unlock",
